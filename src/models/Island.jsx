...
const Island = ({ isRotating, setIsRotating,setCurrentStage, ...props }) => {
  ...
  const handleMousePointerDown = (e) => {
    e.stopPropagation();
    e.preventDefault();
    setIsRotating(true);
  ...
  const handleMousePointerUp = (e) => {
    e.stopPropagation();
    e.preventDefault();
    setIsRotating(false);
  };

  const handleMousePointerMove = (e) => {
    e.stopPropagation();
    e.preventDefault();
    if (isRotating) {
      const clientX = e.touches ? e.touches[0].clientX : e.clientX;
  ...
  useEffect(() => {
    ...
    canvas.addEventListener("pointerdown", handleMousePointerDown);
    canvas.addEventListener("pointerup", handleMousePointerUp);
    canvas.addEventListener("pointermove", handleMousePointerMove);
    document.addEventListener("keydown", handleKeyDown);
    document.addEventListener("keyup", handleKeyUp);

    return () => {
      canvas.removeEventListener("pointerdown", handleMousePointerDown);
      canvas.removeEventListener("pointerup", handleMousePointerUp);
      canvas.removeEventListener("pointermove", handleMousePointerMove);
